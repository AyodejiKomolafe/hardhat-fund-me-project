  ...
  : describe("Fundme", function () {
      ...
      describe("withdraw", async function () {
        ...
        it("Only allows the owner to withdraw", async function () {
          ...
          await expect(connectedAttacker.withdraw()).to.be.rejectedWith(
            "FundMe__NotOwner"
          );
        });
      ...
      describe("fallback", async function () {
        ...
        it("should recieve ether using fallback function", async function () {
          const finalBalance = await ethers.provider.getBalance(fundMe);
      ...
      describe("receive", async function () {
        ...
        it("should call fund function and add funder to getFunder array", async function () {
          const response = await fundMe.getFunder(0);
          assert.equal(response, deployer.address);
        });
      });
